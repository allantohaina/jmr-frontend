        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-[#EAA100]/5">
              {quotes.map((quote) => (
                <tr key={quote.id} className="hover:bg-[#EAA100]/5 transition-colors group">
                  ...
                  <td className="p-4 font-headline font-bold text-[#EAA100] text-lg">{quote.amount ?? "-"}</td>
                  <td className="p-4">
                    {quote.status === "sent" ? (
                      ...
                      <span className="material-symbols-outlined text-[#EAA100]/20">check_circle</span>
                    )}
                  </td>
                </tr>
              ))}
          ...
          {quotes.length === 0 && (
            <div className="py-12 md:py-20 text-center">
              <span className="material-symbols-outlined text-5xl text-[#EAA100]/10 mb-4">description</span>
              <p className="text-[#EAA100]/40 text-sm font-medium">Aucun devis disponible pour le moment.</p>
            </div>
          )}
        </div>
      </div>
