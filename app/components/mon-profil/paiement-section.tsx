...
export function PaiementSection({ id }: { id: string }) {
  ...
  return (
    <section
      ...
      className="mx-auto max-w-2xl rounded-[2rem] border border-[#FFB31B]/5 bg-[#25303a] p-5 shadow-sm sm:p-8 md:rounded-[2.5rem] md:p-10"
    >
      <header className="mb-8">
        <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#FFB31B]/10 text-[#FFB31B]">
          <UploadCloud className="h-6 w-6" />
        </div>
        <h1 className="font-headline text-2xl font-bold text-[#FFB31B] sm:text-3xl" id="paiement-title">
          Confirmer le paiement
        </h1>
        <p className="mt-2 text-sm text-[#FFB31B]/60">
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        <div className="space-y-4">
          <label className="block">
            <span className="mb-2 block text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">
              Methode de paiement
            </span>
            <div className="relative">
              <select
                className="h-14 w-full appearance-none rounded-2xl border border-[#FFB31B]/10 bg-[#1e2a38] px-4 pr-12 font-medium text-[#FFB31B] outline-none transition-all focus:border-[#FFB31B]"
                name="payment_type"
                required
              >
              ...
              <ChevronDown className="pointer-events-none absolute right-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[#FFB31B]" />
            </div>
          </label>
          ...
          <label className="block">
            ...
            <input
              className="h-14 w-full rounded-2xl border border-[#FFB31B]/10 bg-[#1e2a38] px-4 font-medium text-[#FFB31B] outline-none transition-all placeholder:text-[#FFB31B]/20 focus:border-[#FFB31B]"
          ...
          <label className="block">
            ...
            <input
              ...
              className="h-14 w-full cursor-pointer rounded-2xl border border-[#FFB31B]/10 bg-[#1e2a38] px-4 py-3 text-[#FFB31B] transition-all file:mr-4 file:rounded-full file:border-0 file:bg-[#FFB31B]/10 file:px-4 file:py-1 file:text-[10px] file:font-bold file:uppercase file:text-[#FFB31B] hover:file:bg-[#FFB31B]/20"
        ...
        <button
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-[#FFB31B] py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-[#1e2a38] shadow-lg transition-all hover:bg-[#FFB31B] disabled:cursor-not-allowed disabled:opacity-60"
