  ...
  return (
    ...
    >
      <header className="mb-8">
        ...
        <h1 className="font-headline text-2xl font-bold text-[#EAA100] sm:text-3xl" id="paiement-title">
          Confirmer le paiement
        </h1>
        <p className="mt-2 text-sm text-[#EAA100]/60">
        ...
        <div className="space-y-4">
          <label className="block">
            ...
            <div className="relative">
              <select
                className="h-14 w-full appearance-none rounded-2xl border border-[#EAA100]/10 bg-[#1e2a38] px-4 pr-12 font-medium text-[#EAA100] outline-none transition-all focus:border-[#EAA100]"
                name="payment_type"
                required
              >
              ...
              <ChevronDown className="pointer-events-none absolute right-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[#EAA100]" />
            </div>
          </label>
          ...
          <label className="block">
            ...
            <input
              className="h-14 w-full rounded-2xl border border-[#EAA100]/10 bg-[#1e2a38] px-4 font-medium text-[#EAA100] outline-none transition-all placeholder:text-[#EAA100]/20 focus:border-[#EAA100]"
