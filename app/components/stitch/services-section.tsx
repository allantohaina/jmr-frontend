      ...
      <div className="px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-20 gap-6 md:gap-8">
          <div className="max-w-2xl">
            <h2 className="font-headline text-3xl md:text-4xl lg:text-5xl text-[#FFF8EC] mb-4 md:mb-6">
              <EditableText contentKey="services.title" fallback={messages.services.title} as="span" multiline />
            </h2>
            <p className="font-body text-[#B9C3D0] text-base md:text-lg leading-relaxed">
              <EditableText contentKey="services.description" fallback={messages.services.description} as="span" multiline />
            </p>
          </div>
          <div className="font-body text-caption md:text-xs font-bold uppercase tracking-widest text-primary flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div className="md:col-span-2 group relative overflow-hidden rounded-2xl md:rounded-[2rem] bg-surface min-h-[320px] sm:min-h-[400px] md:min-h-[480px] lg:min-h-[500px] shadow-lg">
            <EditableImage
            ...
            <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-auto text-[#FFF8EC] z-10">
              <span className="font-body text-caption uppercase tracking-[0.3em] text-secondary mb-2 block font-bold">
              ...
              <p className="font-body text-sm md:text-base text-white/85 max-w-md mb-4 md:mb-6">
          ...
          <div className="bg-primary p-8 md:p-10 rounded-2xl md:rounded-[2rem] flex flex-col justify-between text-on-primary shadow-2xl shadow-primary/30 relative overflow-hidden group min-h-[320px] md:min-h-0">
            ...
            <div className="pt-8 md:pt-10 border-t border-on-primary/10 relative z-10">
              <ul className="space-y-3 md:space-y-4">
                <li className="flex items-center gap-3 text-caption md:text-xs uppercase tracking-widest font-body font-bold"><span className="w-2 h-2 rounded-full bg-on-primary shrink-0"></span> <span><EditableText contentKey="services.bullet1" fallback={messages.services.bullet1} /></span></li>
                <li className="flex items-center gap-3 text-caption md:text-xs uppercase tracking-widest font-body font-bold"><span className="w-2 h-2 rounded-full bg-on-primary shrink-0"></span> <span><EditableText contentKey="services.bullet2" fallback={messages.services.bullet2} /></span></li>
                <li className="flex items-center gap-3 text-caption md:text-xs uppercase tracking-widest font-body font-bold"><span className="w-2 h-2 rounded-full bg-on-primary shrink-0"></span> <span><EditableText contentKey="services.bullet3" fallback={messages.services.bullet3} /></span></li>
              </ul>
            </div>
          </div>

          <div className="group relative overflow-hidden rounded-2xl md:rounded-[2rem] bg-surface min-h-[280px] sm:min-h-[340px] md:min-h-[400px] shadow-md">
            <EditableImage
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-6 md:p-8 text-center z-10">
              <div className="bg-surface/90 backdrop-blur-md p-6 md:p-8 rounded-2xl border border-primary/20 shadow-xl group-hover:scale-105 transition-transform duration-500">
                <h3 className="font-headline text-xl md:text-2xl text-[#FFF8EC] mb-2"><EditableText contentKey="services.service3Title" fallback={messages.services.service3Title} as="span" multiline /></h3>
                <p className="font-body text-caption uppercase tracking-[0.2em] text-secondary font-bold"><EditableText contentKey="services.service3Eyebrow" fallback={messages.services.service3Eyebrow} /></p>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2 relative overflow-hidden rounded-2xl md:rounded-[2rem] bg-background min-h-[480px] md:min-h-[400px] flex flex-col md:flex-row md:items-center shadow-xl">
            ...
            <div className="relative z-10 p-6 sm:p-8 md:px-12 md:py-10 max-w-md">
              ...
              <p className="font-body text-[#B9C3D0] text-base md:text-lg mb-6 md:mb-10 leading-relaxed">
