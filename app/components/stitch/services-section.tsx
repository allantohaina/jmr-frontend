      ...
      <div className="px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div className="md:col-span-2 group relative overflow-hidden rounded-[1.5rem] md:rounded-[2rem] bg-surface min-h-[320px] sm:min-h-[400px] md:min-h-[480px] lg:min-h-[500px] shadow-lg">
            ...
            <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-auto text-[#EAA100] z-10">
              ...
              <p className="font-body text-sm md:text-base text-[#EAA100]/85 max-w-md mb-4 md:mb-6">
