          ...
          <div className="bg-primary p-8 md:p-10 rounded-[1.5rem] md:rounded-[2rem] flex flex-col justify-between text-on-primary shadow-2xl shadow-primary/30 relative overflow-hidden group min-h-[320px] md:min-h-0">
            ...
            <div className="relative z-10">
              ...
              <h3 className="font-headline text-2xl md:text-3xl mb-4 md:mb-6">
                {messages.services.service2Title}
              </h3>
              <p className="font-body text-sm md:text-base text-on-primary/70 leading-relaxed">
                {messages.services.service2Desc}
              </p>
            </div>
            <div className="pt-8 md:pt-10 border-t border-on-primary/10 relative z-10">
              <ul className="space-y-3 md:space-y-4">
                <li className="flex items-center gap-3 text-[10px] md:text-xs uppercase tracking-widest font-body font-bold"><span className="w-2 h-2 rounded-full bg-on-primary shrink-0"></span> <span>{messages.services.bullet1}</span></li>
                <li className="flex items-center gap-3 text-[10px] md:text-xs uppercase tracking-widest font-body font-bold"><span className="w-2 h-2 rounded-full bg-on-primary shrink-0"></span> <span>{messages.services.bullet2}</span></li>
                <li className="flex items-center gap-3 text-[10px] md:text-xs uppercase tracking-widest font-body font-bold"><span className="w-2 h-2 rounded-full bg-on-primary shrink-0"></span> <span>{messages.services.bullet3}</span></li>
              </ul>
            </div>
          </div>
