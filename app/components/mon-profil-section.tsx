...
:root{
  --bg:#1e2a38;
  --card:#25303a;
  --card-border:rgba(255, 180, 45,0.12);
  --input-bg:#1b263c;
  --gold:#FFB42D;
  --gold-light:#FFB42D;
  --gold-dim:rgba(255, 180, 45,0.4);
  --text-cream:#f3efe4;
  --text-muted:rgba(255, 180, 45,0.6);
  --text-faint:rgba(255, 180, 45,0.35);
  --warn:#e08b52;
...
.db-banner::after{content:"";position:absolute;inset:0;background:radial-gradient(circle at 85% 30%,rgba(255, 180, 45,0.08),transparent 60%);pointer-events:none;}
.db-banner-eyebrow{display:flex;align-items:center;gap:10px;margin-bottom:14px;}
.db-banner-eyebrow .icon{width:32px;height:32px;border-radius:8px;background:rgba(255, 180, 45,0.1);display:flex;align-items:center;justify-content:center;}
...
.db-metric-icon{width:44px;height:44px;border-radius:10px;background:rgba(255, 180, 45,0.08);display:flex;align-items:center;justify-content:center;flex-shrink:0;}
...
.db-filters{display:flex;flex-wrap:wrap;gap:12px;padding:16px 26px;border-bottom:1px solid rgba(255, 180, 45,0.06);}
...
.db-quote-row{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:18px 26px;border-bottom:1px solid rgba(255, 180, 45,0.06);transition:background .2s;}
.db-quote-row:last-child{border-bottom:none;}
.db-quote-row:hover{background:rgba(255, 180, 45,0.02);}
...
.db-draft-progress-track{flex:1;height:5px;border-radius:100px;background:rgba(255, 180, 45,0.1);overflow:hidden;}
...
.db-see-more{width:100%;padding:14px;border:none;background:transparent;border-top:1px solid rgba(255, 180, 45,0.06);font-size:10px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:var(--gold);cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;transition:background .2s;}
.db-see-more:hover{background:rgba(255, 180, 45,0.03);}
...
.db-doc-summary-item{display:flex;align-items:center;gap:10px;padding:11px;border:1px solid rgba(255, 180, 45,.1);border-radius:8px;background:rgba(27,38,60,.45);}
...
.db-doc-row{display:flex;gap:10px;align-items:center;padding:10px;border-radius:8px;background:rgba(255, 180, 45,.035);text-decoration:none;color:inherit;}
.db-doc-row[href]:hover{background:rgba(255, 180, 45,.09);}
.db-doc-icon{width:28px;height:32px;display:grid;place-items:center;flex:none;border-radius:6px;background:rgba(255, 180, 45,.1);color:var(--gold);font-family:var(--font-mono);font-size:8px;font-weight:800;}
...
.db-alert-row{display:flex;align-items:flex-start;gap:12px;padding:16px 26px;border-bottom:1px solid rgba(255, 180, 45,0.06);}
...
.site-footer{padding:36px 0 70px;text-align:center;font-size:12px;color:var(--text-faint);border-top:1px solid rgba(255, 180, 45,0.06);margin-top:40px;}
`;
        ...
        <main className="db-container" style={{ paddingTop: 32 }}>
          ...
          {!hasData && !isLoading ? (
            <div style={{ textAlign: "center", padding: "60px 0" }}>
              <div style={{ width: 64, height: 64, borderRadius: "50%", background: "rgba(255, 180, 45,0.08)", display: "inline-flex", alignItems: "center", justifyContent: "center", marginBottom: 24 }}>
