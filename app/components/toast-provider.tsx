            ...
            >
              <div className={`flex items-center gap-4 p-5 rounded-[1.5rem] shadow-2xl border min-w-[320px] max-w-md bg-[#25303a] backdrop-blur-md ${
                ...
                <div className="flex-1">
                  <p className="text-sm font-bold text-[#EAA100] leading-tight">{toast.message}</p>
                </div>

                <button 
                  onClick={() => removeToast(toast.id)}
                  className="p-2 hover:bg-[#EAA100]/10 rounded-lg transition-colors text-[#EAA100]/20 hover:text-[#EAA100]/40"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
