...
export default function ExchangeRateWidget() {
  ...
  if (error) {
    return (
      <div className="rounded-xl border border-[#EAA100]/10 bg-[#25303a] p-6">
        ...
        <button
          onClick={refresh}
          className="mt-3 rounded-lg border border-[#EAA100]/15 px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-[#EAA100] transition-colors hover:bg-[#EAA100]/10"
        >
          Réessayer
        </button>
      </div>
    ...
    <div className="rounded-xl border border-[#EAA100]/10 bg-[#25303a] p-6">
      ...
      <div className="space-y-4">
        {isLoading && !rates ? (
          ...
          <>
            <div className="rounded-xl border border-[#EAA100]/5 bg-[#26313d] p-4">
