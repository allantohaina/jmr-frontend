  ...
  return (
    <>
      <nav className="site-nav" aria-label={messages.navbar.ariaLabel}>
        ...
        <ul className="site-nav__menu" id="site-nav-menu">
            ...
            if (item.sectionId === "acces-client" && effectiveIsSignedIn) {
              return (
                <li className="site-nav__item site-nav__item--profile relative group" key={item.sectionId}>
                  ...
                  {isProfileOpen && (
                    <div className="absolute top-full right-0 mt-2 w-48 bg-[#25303a] border border-[#FFB42D]/20 rounded-xl shadow-xl py-2 z-[110] animate-in fade-in zoom-in-95 duration-200">
                      <Link
                        href="/mon-profil"
                        className="flex items-center gap-3 px-4 py-3 hover:bg-[#1e2a38] text-sm font-medium text-[#FFB42D] transition-colors"
                      ...
                      <div className="h-px bg-[#FFB42D]/20 mx-2 my-1"></div>
                      <button
                        type="button"
          ...
          {hasNotifications && (
            <li className="site-nav__item site-nav__item--notif relative">
              ...
              >
                <span className="relative inline-flex">
                  ...
                  {unreadNotifications > 0 && (
                    <span className="absolute -top-1 -right-1 flex h-[18px] min-w-[18px] items-center justify-center rounded-full bg-[#FFB42D] px-1 text-[10px] font-bold leading-none text-[#1e2a38]">
              ...
              {isNotifOpen && (
                <div className="absolute top-full right-0 mt-2 w-80 bg-[#25303a] border border-[#FFB42D]/20 rounded-xl shadow-xl py-4 px-4 z-[110] animate-in fade-in zoom-in-95 duration-200">
                  <h3 className="text-sm font-semibold text-[#FFB42D] mb-3">{messages.notifications.bellTitle}</h3>
        ...
        <button
          type="button"
          className="max-[900px]:flex max-[900px]:items-center max-[900px]:justify-center hidden h-10 w-10 rounded-xl transition-colors hover:bg-[#FFB42D]/10"
          onClick={handleToggleBurger}
          aria-label="Menu"
          aria-expanded={isMenuOpen}
          aria-controls="site-mobile-menu"
        >
          <span className="material-symbols-outlined text-[#FFB42D] text-2xl">
