...
export function ProfileSkeleton() {
  return (
    <div className="bg-[#25303a] p-10 rounded-[2rem] border border-[#EAA100]/5 shadow-sm">
...
export function CardSkeleton() {
  return (
    <div className="bg-[#25303a] p-6 rounded-[2rem] border border-[#EAA100]/5 shadow-sm space-y-4">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2">
            <div className="bg-[#25303a] rounded-[2.5rem] border border-[#EAA100]/5 p-8 space-y-6">
              {[1, 2, 3, 4, 5].map(i => (
