...
export default function BrouillonsClient({ onCountChange }: BrouillonsClientProps) {
  ...
  return (
    <div>
      ...
      {sorted.length === 0 ? (
        <div className="mt-4 flex flex-col items-center border border-dashed border-[#EAA100]/15 rounded-xl px-6 py-10 text-center">
          <FileText className="mb-3 h-8 w-8 text-[#EAA100]/20" />
          <p className="font-headline text-base text-[#EAA100]">Aucun brouillon pour l&apos;instant</p>
          <p className="mt-1 text-xs text-[#EAA100]/50">
        ...
        >
          <div className="w-full max-w-lg rounded-xl border border-[#EAA100]/15 bg-[#161D30] p-7">
            ...
            <form onSubmit={saveDraft} className="mt-6 space-y-4">
              ...
              <div className="flex justify-end gap-2 border-t border-[#EAA100]/10 pt-5">
                <button
                  type="button"
                  onClick={closeModal}
                  className="rounded-lg border border-[#EAA100]/15 px-4 py-2.5 text-xs text-[#EAA100]/60 transition-colors hover:border-[#EAA100]/40 hover:text-[#EAA100]"
                >
                  Annuler
                </button>
                <button
                  type="submit"
                  className="rounded-lg bg-[#EAA100] px-4 py-2.5 text-xs font-bold uppercase tracking-widest text-[#1e2a38] transition-colors hover:bg-[#EAA100]"
                >
