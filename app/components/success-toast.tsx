...
export function SuccessToast() {
  ...
  return (
    <div className="fixed bottom-10 left-1/2 z-[9999] -translate-x-1/2 animate-toast-up">
      <div className="flex items-center gap-4 rounded-full bg-[#EAA100] px-8 py-4 font-bold text-[#1e2a38] shadow-2xl shadow-[#EAA100]/20 border border-[#EAA100]/20 backdrop-blur-md">
