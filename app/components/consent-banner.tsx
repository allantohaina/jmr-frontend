  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl px-4 pb-4">
        <div className="rounded-2xl border border-[#EAA100]/25 bg-[#1e2a38] p-5 shadow-2xl">
          <h2 className="text-base font-semibold text-[#EAA100]">
            {messages.consent.bannerTitle}
          </h2>
          <p className="mt-2 text-sm text-white/70">{messages.consent.bannerText}</p>
          <Link
            href="/confidentialite"
            className="mt-2 inline-block text-sm text-[#EAA100] underline underline-offset-4 hover:text-[#EAA100]"
          >
          ...
          <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-2 text-sm text-white/80">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" defaultChecked className="accent-[#EAA100]" />
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="accent-[#EAA100] disabled:opacity-40"
                />
            ...
            <div className="flex gap-2">
              <button
                ...
                className="rounded-lg bg-[#EAA100] px-4 py-2 text-sm font-semibold text-[#163526] transition-colors hover:bg-[#EAA100] disabled:cursor-not-allowed disabled:opacity-60"
              >
