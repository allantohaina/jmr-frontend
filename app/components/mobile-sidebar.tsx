...
export function MobileSidebar({ isStaff, userFirstName }: MobileDrawerProps) {
  ...
  return (
    <>
      <button
        onClick={openDrawer}
        className="relative z-50 flex h-10 w-10 items-center justify-center rounded-xl transition-colors hover:bg-[#EAA100]/10 md:hidden"
        aria-label="Ouvrir le menu"
      >
        {open ? (
          <X className="h-5 w-5 text-[#EAA100]" />
        ) : (
          <Menu className="h-5 w-5 text-[#EAA100]" />
        )}
      </button>
      ...
      >
        <div className="flex items-center justify-between border-b border-[#EAA100]/10 px-6 py-5">
          <span className="font-headline text-lg font-bold tracking-wide text-[#EAA100]">
            JMR Textile
          </span>
          <button
            onClick={closeDrawer}
            className="flex h-10 w-10 items-center justify-center rounded-xl transition-colors hover:bg-[#EAA100]/10"
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-4 rounded-xl px-4 py-3.5 text-sm font-bold uppercase tracking-widest transition-all ${
                      active
                        ...
                        : "text-[#EAA100]/70 hover:bg-[#EAA100]/5 hover:text-[#EAA100]"
                    }`}
                  >
                    <Icon className={`h-5 w-5 ${active ? "text-[#EAA100]" : "text-[#EAA100]/40"}`} />
                    {label}
                  </Link>
                </li>
              );
              ...
              <ul className="space-y-1">
                {isStaff && (
                  <li>
                    <Link
                      href="/backoffice"
                      onClick={closeDrawer}
                      className="flex items-center gap-4 rounded-xl px-4 py-3.5 text-sm font-bold uppercase tracking-widest text-[#EAA100]/70 transition-all hover:bg-[#EAA100]/5 hover:text-[#EAA100]"
                    >
                      <Settings className="h-5 w-5 text-[#EAA100]/40" />
                      Backoffice
                    </Link>
                  </li>
                )}
                <li>
                  <Link
                    ...
                    className="flex items-center gap-4 rounded-xl px-4 py-3.5 text-sm font-bold uppercase tracking-widest text-[#EAA100]/70 transition-all hover:bg-[#EAA100]/5 hover:text-[#EAA100]"
                  >
                    <User className="h-5 w-5 text-[#EAA100]/40" />
