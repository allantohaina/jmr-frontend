...
export function PrivilegeBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-2 py-0.5 bg-amber-50 text-amber-700 border border-amber-200 text-micro font-bold uppercase tracking-widest rounded-full shrink-0 ${className}`}
    >
