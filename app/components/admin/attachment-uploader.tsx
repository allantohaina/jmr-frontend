    ...
    <div className="space-y-4">
      ...
      <div
        ...
        className={`border-2 border-dashed rounded-xl p-6 text-center transition-colors ${
          dragActive
            ...
            : "border-[#F5A623]/10 bg-[#1e2a38] hover:border-[#F5A623]/10/30"
        }`}
      >
        <input
          type="file"
        ...
        >
          <Upload className={`mx-auto h-10 w-10 ${dragActive ? "text-orange-500" : "text-[#F5A623]/40"}`} />
          ...
          <p className="text-[10px] text-[#F5A623]/40 uppercase tracking-widest mt-1">
      ...
      {isLoading ? (
        ...
        <div className="space-y-2">
          <p className="text-[10px] font-bold uppercase tracking-widest text-[#F5A623]/40">
          ...
          <div className="space-y-2">
            {attachments.map((att) => (
              <div
                key={att.id}
                className="flex items-center gap-3 p-3 bg-[#25303a] border border-[#F5A623]/10 rounded-xl hover:border-[#F5A623]/10/20 transition-colors"
              >
                <div className="flex-shrink-0">{getFileIcon(att.mime_type)}</div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-[#F5A623] truncate">{att.original_name}</p>
                  <p className="text-[10px] text-[#F5A623]/40 uppercase tracking-widest">
                ...
                <a
                  ...
                  className="p-2 text-[#F5A623]/60 hover:text-orange-500 transition-colors"
                  title="Ouvrir"
                >
