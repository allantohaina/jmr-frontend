    ...
    <div className="space-y-4">
      ...
      <div
        ...
        className={`border-2 border-dashed rounded-xl p-6 text-center transition-colors ${
          dragActive
            ...
            : "border-[#EAA100]/10 bg-[#1e2a38] hover:border-[#EAA100]/10/30"
        }`}
      >
        <input
          type="file"
        ...
        >
          <Upload className={`mx-auto h-10 w-10 ${dragActive ? "text-orange-500" : "text-[#EAA100]/40"}`} />
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-4">
          <Loader2 className="h-5 w-5 animate-spin text-[#EAA100]" />
        </div>
            ...
            {attachments.map((att) => (
              ...
              >
                ...
                <a
                  ...
                  className="p-2 text-[#EAA100]/60 hover:text-orange-500 transition-colors"
                  title="Ouvrir"
                >
