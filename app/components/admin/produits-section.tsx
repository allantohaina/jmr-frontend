  ...
  return (
    <div className="px-4 md:px-12 py-8 md:py-10 space-y-8">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="font-headline text-2xl md:text-3xl text-[#FFB31B]">Fiches Produits</h2>
          <p className="text-xs font-bold uppercase tracking-widest text-[#FFB31B]/40 mt-1">Référentiel des produits de l&apos;atelier</p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-[#25303a] rounded-2xl p-6 md:p-8 border border-[#FFB31B]/10 shadow-sm">
          <h3 className="font-headline text-xl text-[#FFB31B] mb-6">{editingId ? "Modifier" : "Créer"} un produit</h3>
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Nom du produit *</label>
              <input
                required
                value={formData.nom}
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Catégorie</label>
              <input
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Conso par taille (JSON)</label>
              <input
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Niveau difficulté défaut *</label>
              <input
                required
                type="number"
                step="0.1"
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">MOQ *</label>
              <input
                required
                type="number"
                value={formData.moq}
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Coût matière défaut (Ar/m) *</label>
              <input
                required
                type="number"
                step="0.01"
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Photo URL</label>
              <input
            ...
            <div className="space-y-2 md:col-span-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Description</label>
              <textarea
            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="border-b border-[#FFB31B]/10 bg-[#FFB31B]/10">
                  <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Nom</th>
                  <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Catégorie</th>
                  <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Conso tissu</th>
                  <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">Difficulté</th>
                  <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40">MOQ</th>
...
produits.map((p) => (
                      ...
                      <td className="px-6 py-4">
                        <p className="text-sm font-bold text-[#FFB31B]">{p.nom}</p>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-xs text-[#FFB31B]/60">{p.categorie || "—"}</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-xs font-mono text-[#FFB31B]">{p.conso_tissu_unitaire} m</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-xs font-mono text-[#FFB31B]">x{p.niveau_difficulte_defaut}</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-xs font-mono text-[#FFB31B]">{p.moq}</span>
                      </td>
       ...
       {selectedProduitId && (
         <div className="bg-[#25303a] rounded-2xl border border-[#FFB31B]/10 shadow-sm overflow-hidden mt-6">
           <div className="p-6 border-b border-[#FFB31B]/10 flex justify-between items-center">
             <div>
               <h3 className="font-headline text-xl text-[#FFB31B]">Détails du produit</h3>
