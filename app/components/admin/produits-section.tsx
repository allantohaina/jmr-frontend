  ...
  return (
    <div className="px-4 md:px-12 py-8 md:py-10 space-y-8">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="font-headline text-2xl md:text-3xl text-[#EAA100]">Fiches Produits</h2>
          <p className="text-xs font-bold uppercase tracking-widest text-[#EAA100]/40 mt-1">Référentiel des produits de l&apos;atelier</p>
        </div>
        <button
...
produits.map((p) => (
                      ...
                      <td className="px-6 py-4">
                        <p className="text-sm font-bold text-[#EAA100]">{p.nom}</p>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-xs text-[#EAA100]/60">{p.categorie || "—"}</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-xs font-mono text-[#EAA100]">{p.conso_tissu_unitaire} m</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-xs font-mono text-[#EAA100]">x{p.niveau_difficulte_defaut}</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-xs font-mono text-[#EAA100]">{p.moq}</span>
                      </td>
