  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        ...
        .pe-grid label, .pe-row label, .pe-line label { display: flex; flex-direction: column; gap: 6px; font-size: 10px; font-weight: 800; letter-spacing: .1em; text-transform: uppercase; color: rgba(255,180,45,.55); }
        .span2 { grid-column: span 2; }
        .pe-form input, .pe-form textarea, .pe-form select {
          background: #1e2a38; border: 1px solid rgba(255,180,45,.15); border-radius: 10px;
          padding: 10px 12px; color: #FFB42D; font-size: 14px; text-transform: none; letter-spacing: normal; font-weight: 400; width: 100%;
        }
        .pe-form input:focus, .pe-form textarea:focus, .pe-form select:focus { outline: none; border-color: rgba(255,180,45,.5); }
        ...
        .pe-lines-head h3 { margin: 0; font-size: 13px; color: #FFB42D; text-transform: uppercase; letter-spacing: .14em; }
        .pe-add { background: rgba(255,180,45,.12); border: 1px solid rgba(255,180,45,.3); color: #FFB42D; border-radius: 10px; padding: 8px 14px; font-size: 11px; font-weight: 700; cursor: pointer; }
        .pe-line { display: grid; grid-template-columns: 2fr 1.4fr .6fr .6fr 1fr .7fr auto auto; gap: 8px; align-items: end; background: rgba(30,42,56,.6); border: 1px solid rgba(255,180,45,.08); border-radius: 12px; padding: 10px; }
        .pe-line .span2 { grid-column: span 1; }
        .pe-line-total { font-size: 13px; font-weight: 700; color: #FFB42D; padding-bottom: 10px; white-space: nowrap; }
        ...
        .pe-totals { display: flex; flex-wrap: wrap; gap: 8px 20px; background: #1e2a38; border: 1px solid rgba(255,180,45,.12); border-radius: 12px; padding: 12px 16px; font-size: 13px; color: rgba(255,180,45,.75); }
        .pe-totals .grand { color: #FFB42D; font-size: 15px; }
        .pe-error { color: #ff8080; font-size: 13px; margin: 0; }
        .pe-actions { display: flex; justify-content: flex-end; gap: 10px; }
        .pe-btn { background: #FFB42D; color: #1e2a38; border: 0; border-radius: 12px; padding: 12px 22px; font-size: 12px; font-weight: 800; letter-spacing: .08em; text-transform: uppercase; cursor: pointer; }
        .pe-btn:disabled { opacity: .5; cursor: not-allowed; }
        .pe-btn.ghost { background: transparent; border: 1px solid rgba(255,180,45,.25); color: #FFB42D; }
