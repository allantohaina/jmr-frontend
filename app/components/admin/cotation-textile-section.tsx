  ...
  return (
    <div className="px-4 md:px-12 py-8 md:py-10 space-y-8">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="font-headline text-2xl md:text-3xl text-[#EAA100]">Cotation Textile</h2>
          <p className="text-xs font-bold uppercase tracking-widest text-[#EAA100]/40 mt-1">Calcul automatique des prix</p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-[#1e2a38] border-none p-3 rounded-xl text-xs font-bold text-[#EAA100] outline-none focus:ring-2 focus:ring-[#163526]/10 disabled:opacity-50"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-[#1e2a38] border-none p-3 rounded-xl text-xs font-bold text-[#EAA100] outline-none focus:ring-2 focus:ring-[#EAA100]/10"
                  >
