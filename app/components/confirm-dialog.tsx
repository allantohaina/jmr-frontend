...
.jmr-confirm{width:100%;max-width:420px;background:var(--card,#25303a);border:1px solid var(--card-border,rgba(234, 161, 0,0.12));border-radius:12px;padding:26px;box-shadow:0 24px 60px rgba(0,0,0,0.4);}
...
.jmr-confirm h3{font-family:var(--font-serif,'Fraunces',serif);font-weight:500;font-size:20px;color:var(--gold-light,#EAA100);margin:0 0 8px;}
...
.jmr-confirm-btn.primary{background:linear-gradient(180deg,var(--gold-light,#EAA100),var(--gold,#EAA100));color:#1a1204;}
