  ...
  if (!isMounted) {
    return (
      <div style={{ minHeight: "100vh", background: "#1e2a38", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ width: 40, height: 40, border: "3px solid #EAA100", borderTopColor: "transparent", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
      ...
      <div className="admin-login-root">
        ...
        <div className="panel">
          <svg className="thread-bg" viewBox="0 0 600 900" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M50 100 Q200 200 150 400 Q100 600 250 800" stroke="#EAA100" strokeWidth="1.5" strokeDasharray="8 6" fill="none" />
            <path d="M120 50 Q300 180 220 450 Q140 720 300 850" stroke="#EAA100" strokeWidth="1" strokeDasharray="6 8" fill="none" />
            <path d="M400 30 Q320 250 380 480 Q440 700 350 880" stroke="#EAA100" strokeWidth="1" strokeDasharray="10 5" fill="none" />
            <path d="M500 120 Q420 300 480 520 Q540 740 430 870" stroke="#EAA100" strokeWidth="1.2" strokeDasharray="5 9" fill="none" />
            <path d="M80 200 Q250 320 180 560 Q110 800 280 900" stroke="#EAA100" strokeWidth="0.8" strokeDasharray="4 10" fill="none" />
          </svg>
        ...
        <div className="form-side">
          <div className="form-badge">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="1" y="8" width="2.5" height="5" rx="0.5" fill="#EAA100" />
              <rect x="4.5" y="5" width="2.5" height="8" rx="0.5" fill="#EAA100" />
              <rect x="8" y="2.5" width="2.5" height="10.5" rx="0.5" fill="#EAA100" />
              <rect x="11.5" y="0.5" width="2" height="12.5" rx="0.5" fill="#EAA100" />
            </svg>
            Administration
          </div>
