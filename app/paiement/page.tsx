        ...
        {isLoading ? (
          ...
          <div className="rounded-2xl border border-[#EAA100]/15 bg-[#25303a] p-8">
            ...
            <div className="mt-6 space-y-3 text-sm">
              <div className="flex justify-between"><span className="text-[#EAA100]/50">Commande</span><span className="font-bold text-[#EAA100]">{lien.commande_numero || "—"}</span></div>
              <div className="flex justify-between"><span className="text-[#EAA100]/50">Désignation</span><span className="text-[#EAA100]">{lien.commande_designation || "—"}</span></div>
              {lien.client_nom && <div className="flex justify-between"><span className="text-[#EAA100]/50">Client</span><span className="text-[#EAA100]">{lien.client_nom}</span></div>}
              <div className="flex justify-between items-center border-t border-[#EAA100]/10 pt-3 mt-3">
                <span className="text-[#EAA100]/50">Montant à régler</span>
                <span className="font-headline text-2xl text-[#EAA100]">{fmt(lien.montant)}</span>
              </div>
            </div>
...
export default function PaiementPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#1e2a38] text-[#EAA100] flex items-center justify-center"><Loader className="h-6 w-6 animate-spin text-[#EAA100]" /></div>}>
      <PaymentView />
    </Suspense>
  );
}