        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            <input
              ...
              className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none focus:border-[#FFB31B]/50 placeholder:text-white/20"
              required
            />
            <button
              type="submit"
              disabled={isLoading}
              className="w-full rounded-lg bg-[#FFB31B] py-3 text-xs font-bold uppercase tracking-widest text-[#1a2332] disabled:opacity-60"
            >
              ...
              <button
                ...
                className={`w-full text-left p-3 rounded-lg text-sm transition-colors ${
                  selectedEmail === u.email
                    ? "bg-[#FFB31B]/20 border border-[#FFB31B]/40 text-[#FFB31B]"
