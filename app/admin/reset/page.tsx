        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            <input
              ...
              className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none focus:border-[#EAA100]/50 placeholder:text-white/20"
              required
            />
            <button
              type="submit"
              ...
              <button
                ...
                className={`w-full text-left p-3 rounded-lg text-sm transition-colors ${
                  selectedEmail === u.email
                    ? "bg-[#EAA100]/20 border border-[#EAA100]/40 text-[#EAA100]"
