          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full p-5 bg-[#1e2a38] border border-[#EAA100]/10 rounded-2xl text-lg font-bold text-[#EAA100] focus:outline-none focus:ring-2 focus:ring-[#EAA100]/20 placeholder:text-[#EAA100]/20"
              />
            </div>
