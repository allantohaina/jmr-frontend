  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-[10px] uppercase tracking-widest text-[#EAA100]/40 font-bold mt-1">Spécifications de fabrication</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
            ...
            <button
              ...
              className={`w-full text-left p-6 rounded-[2rem] border transition-all ${
                selectedSheet?.id === sheet.id 
                  ...
                  : "bg-[#25303a] text-[#EAA100] border-[#EAA100]/5 hover:border-[#EAA100]/20"
              }`}
            >
              <div className="flex justify-between items-start mb-2">
                <span className={`text-[10px] font-bold uppercase tracking-widest ${selectedSheet?.id === sheet.id ? "text-[#1e2a38]/60" : "text-[#EAA100]"}`}>
                  {sheet.orderId}
                </span>
              ...
              <p className={`text-[10px] uppercase tracking-widest font-bold ${selectedSheet?.id === sheet.id ? "text-[#1e2a38]/40" : "text-[#EAA100]/40"}`}>
                {sheet.client}
              </p>
            </button>
          ))}
        ...
        <div className="lg:col-span-2">
          {selectedSheet ? (
            <div className="bg-[#25303a] rounded-[2.5rem] border border-[#EAA100]/5 shadow-sm overflow-hidden animate-in slide-in-from-right-4 duration-500">
              ...
              <div className="p-8 grid md:grid-cols-2 gap-12">
                <div className="space-y-8">
                  <div>
                    <h4 className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-[#EAA100] mb-6">
                    ...
                    <ul className="space-y-4">
                      {selectedSheet.specs.map((spec, i) => (
                        <li key={i} className="flex justify-between items-center py-3 border-b border-[#EAA100]/5">
                          <span className="text-[10px] font-bold text-[#EAA100]/40 uppercase tracking-widest">{spec.label}</span>
                ...
                <div className="space-y-8">
                  ...
                  <button className="w-full py-4 bg-[#EAA100] text-[#1e2a38] rounded-2xl text-[10px] font-bold uppercase tracking-widest flex items-center justify-center gap-3 shadow-lg hover:bg-[#EAA100] transition-all">
            ...
            <div className="h-full flex flex-col items-center justify-center p-12 bg-[#25303a] rounded-[2.5rem] border-2 border-dashed border-[#EAA100]/10 text-[#EAA100]/20 min-h-[400px]">
