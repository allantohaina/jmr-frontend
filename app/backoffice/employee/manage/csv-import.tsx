      ...
      <div className="rounded-xl border border-[#FFB31B]/10 bg-white/5 p-6">
        <div className="mb-6 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#FFB31B]/10">
            <Upload className="h-5 w-5 text-[#FFB31B]" />
          </div>
          <div>
            <h2 className="text-sm font-bold text-[#FFB31B]">Import CSV</h2>
            <p className="text-[10px] uppercase tracking-widest text-[#FFB31B]/40">
              Importez plusieurs employés d&apos;un seul coup
            </p>
          </div>
        </div>

        <div className="mb-6 rounded-lg border border-dashed border-[#FFB31B]/20 bg-white/5 p-8 text-center">
          <FileText className="mx-auto mb-3 h-10 w-10 text-[#FFB31B]/20" />
          <p className="mb-2 text-sm text-[#FFB31B]/60">
            {file ? file.name : "Glissez un fichier CSV ici ou cliquez pour sélectionner"}
          </p>
          <p className="mb-4 text-[10px] uppercase tracking-widest text-[#FFB31B]/30">
          ...
          <button
            ...
            className="rounded-lg border border-[#FFB31B]/20 bg-white/5 px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/60 transition-colors hover:bg-white/10 hover:text-[#FFB31B]"
          >
        ...
        <div className="mb-6 rounded-lg bg-white/5 p-4">
          <h3 className="mb-2 text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/60">
            Format attendu du CSV
          </h3>
          <pre className="overflow-x-auto text-xs text-[#FFB31B]/40">
...
sara@jmrtextile.com,securepass456,Sara,Elouardi,0600000002,worker,Coupe,Surcheuse,2024-03-20,CD789012`}
          ...
          <p className="mt-2 text-[10px] text-[#FFB31B]/30">
