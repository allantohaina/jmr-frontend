      ...
      <div className="rounded-xl border border-[#EAA100]/10 bg-white/5 p-6">
        <div className="mb-6 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#EAA100]/10">
            <UserPlus className="h-5 w-5 text-[#EAA100]" />
          </div>
          <div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-[#EAA100]/10 bg-white/5 px-4 py-2.5 text-sm text-[#EAA100] outline-none focus:border-[#EAA100]/30"
              />
            </div>
            <div>
