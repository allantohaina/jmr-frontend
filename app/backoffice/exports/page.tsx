...
export default function ExportsPage() {
  ...
  return (
    <div className="px-6 md:px-12 py-10 space-y-8">
      <div className="px-2">
        <h2 className="font-headline text-3xl text-[#EAA100]">Exports comptables</h2>
        <p className="text-[#EAA100]/40 text-xs font-bold uppercase tracking-widest mt-1">Rapports CSV · JMR Atelier</p>
      </div>
