    ...
    <div className="mb-[2px]">
      <button
        ...
        className={`flex w-full items-center gap-[11px] rounded-md border-0 bg-transparent px-3 py-[11px] text-[12.5px] font-semibold tracking-[0.5px] transition-colors ${
          open ? "text-[#FFB31B]" : "text-[#7b8496] hover:bg-[#17202f] hover:text-[#ece7db]"
        }`}
      >
      ...
      {open && (
        <div className="ml-5 space-y-[1px] border-l border-dashed border-[rgba(255, 179, 27,0.14)] pl-2.5">
            ...
            return (
              <Link
                ...
                className={`relative flex items-center gap-2.5 rounded-[5px] px-3 py-[9px] text-[13px] transition-colors ${
                  active
                    ? "bg-[linear-gradient(90deg,rgba(255, 179, 27,0.14),rgba(255, 179, 27,0.02))] text-[#ece7db]"
                    : "text-[#7b8496] hover:bg-[#17202f] hover:text-[#ece7db]"
                }`}
              >
                {active && (
                  <span className="absolute -left-[11px] top-[3px] bottom-[3px] w-[2px] rounded-sm bg-[#FFB31B]" />
                )}
                <Icon className={`h-[15px] w-[15px] shrink-0 ${active ? "text-[#FFB31B] opacity-100" : "opacity-80"}`} />
                {label}
              </Link>
            );
          })}
...
function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#1e2a38] font-body text-[#FFB31B] md:flex">
      <aside className="z-50 flex w-full flex-col bg-[linear-gradient(180deg,#121a28,#0f1622)] shadow-2xl transition-all duration-300 md:fixed md:left-0 md:top-0 md:h-full md:w-64 border-r border-white/5">
        <div className="px-6 pt-7 pb-5 md:block">
          <div>
            <Link href="/" className="mb-[5px] block font-brand text-[23px] font-semibold tracking-[0.5px] text-[#FFB31B]">
              JMR Atelier
            </Link>
        ...
        <div className="mx-6 mb-[6px] border-b border-dashed border-[rgba(255, 179, 27,0.14)]" />
        ...
        <nav className="hidden flex-1 space-y-0 overflow-y-auto px-[14px] py-[10px] md:block">
          ...
          >
            ...
            <LayoutDashboard className={`h-[15px] w-[15px] shrink-0 ${pathname === "/backoffice" ? "text-[#FFB31B] opacity-100" : "opacity-80"}`} />
            Tableau de bord
          </Link>
        ...
        <div className="flex gap-4 overflow-x-auto border-b border-[#FFB31B]/10 bg-[#25303a] p-4 md:hidden">
          <Link href="/backoffice" className="flex-shrink-0 rounded-lg px-3 py-2 hover:bg-[#FFB31B]/5 first:bg-[#FFB31B]/10">
            <div className="flex items-center gap-2">
              <LayoutDashboard className="h-4 w-4 text-[#FFB31B]" />
              <span className="text-[8px] font-bold uppercase tracking-widest">Tableau de bord</span>
            </div>
          </Link>
          <Link href="/backoffice/client/devis" className="flex-shrink-0 rounded-lg px-3 py-2 hover:bg-[#FFB31B]/5">
            <div className="flex items-center gap-2">
              <FileText className="h-4 w-4 text-[#FFB31B]" />
              <span className="text-[8px] font-bold uppercase tracking-widest">Devis</span>
            </div>
          </Link>
          <Link href="/backoffice/client/orders" className="flex-shrink-0 rounded-lg px-3 py-2 hover:bg-[#FFB31B]/5">
            <div className="flex items-center gap-2">
              <Package className="h-4 w-4 text-[#FFB31B]" />
              <span className="text-[8px] font-bold uppercase tracking-widest">Commandes</span>
            </div>
          </Link>
          <Link href="/backoffice/employee/tickets" className="flex-shrink-0 rounded-lg px-3 py-2 hover:bg-[#FFB31B]/5">
            <div className="flex items-center gap-2">
              <Wrench className="h-4 w-4 text-[#FFB31B]" />
              <span className="text-[8px] font-bold uppercase tracking-widest">Tickets</span>
            </div>
          </Link>
          <Link href="/backoffice/employee/tasks" className="flex-shrink-0 rounded-lg px-3 py-2 hover:bg-[#FFB31B]/5">
            <div className="flex items-center gap-2">
              <ClipboardList className="h-4 w-4 text-[#FFB31B]" />
              <span className="text-[8px] font-bold uppercase tracking-widest">Tâches</span>
            </div>
          </Link>
          <Link href="/backoffice/orders" className="flex-shrink-0 rounded-lg px-3 py-2 hover:bg-[#FFB31B]/5">
            <div className="flex items-center gap-2">
              <Package className="h-4 w-4 text-[#FFB31B]" />
              <span className="text-[8px] font-bold uppercase tracking-widest">Prod.</span>
            </div>
          </Link>
          <Link href="/backoffice/delivery-notes" className="flex-shrink-0 rounded-lg px-3 py-2 hover:bg-[#FFB31B]/5">
            <div className="flex items-center gap-2">
              <Truck className="h-4 w-4 text-[#FFB31B]" />
              <span className="text-[8px] font-bold uppercase tracking-widest">BL</span>
            </div>
          </Link>
          <Link href="/backoffice/purchases" className="flex-shrink-0 rounded-lg px-3 py-2 hover:bg-[#FFB31B]/5">
            <div className="flex items-center gap-2">
              <ShoppingCart className="h-4 w-4 text-[#FFB31B]" />
              <span className="text-[8px] font-bold uppercase tracking-widest">Achats</span>
            </div>
          </Link>
          <Link href="/backoffice/finance/invoices" className="flex-shrink-0 rounded-lg px-3 py-2 hover:bg-[#FFB31B]/5">
            <div className="flex items-center gap-2">
              <Receipt className="h-4 w-4 text-[#FFB31B]" />
        ...
        <div className="mt-auto hidden border-t border-white/5 p-[14px] md:block">
          <div className="mb-1 flex cursor-pointer items-center gap-2.5 rounded-lg px-2.5 py-2 transition-colors hover:bg-[#17202f]">
            <div className="flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-full bg-[linear-gradient(135deg,#FFB31B,#FFB31B)] font-brand text-[12px] font-semibold text-[#181205]">
              {profileInitials}
            </div>
            <div>
      ...
      <div className="relative flex min-h-screen flex-1 flex-col md:ml-64">
        <header className="sticky top-0 z-40 flex items-center justify-between border-b border-[#FFB31B]/10 bg-[#1e2a38]/80 px-6 py-4 backdrop-blur-md md:px-12 md:py-6">
          <div>
            <h1 className="font-headline text-xl text-[#FFB31B] md:text-2xl">Espace de Gestion</h1>
            <p className="mt-1 text-[8px] font-bold uppercase tracking-widest text-[#FFB31B]/40 md:text-[10px]">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <AdminHeaderAlerts />
            <div className="hidden h-8 w-[1px] bg-[#FFB31B]/10 md:block" />
            <div className="flex items-center gap-2 md:gap-4">
              <span className="hidden rounded-full bg-[#FFB31B]/10 px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest text-[#FFB31B] md:inline-block">
                Systeme v2.4
              </span>
              <Link href="/" className="text-[#FFB31B]/60 transition-colors hover:text-[#FFB31B]" aria-label="Retour au site">
