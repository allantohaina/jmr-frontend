    ...
    <div className="mx-auto max-w-7xl px-4 py-6 md:px-8 md:py-8">
      ...
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="flex size-10 items-center justify-center rounded-xl border border-[#EAA100]/20 bg-[#EAA100]/10 text-[#EAA100]">
              ...
              <AreaChart data={chartData}>
                <defs>
                  <linearGradient id="colorVentes" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#EAA100" stopOpacity={0.25} />
                    <stop offset="95%" stopColor="#EAA100" stopOpacity={0} />
                  </linearGradient>
                  <linearGradient id="colorDepenses" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#EAA100" stopOpacity={0.2} />
                    <stop offset="95%" stopColor="#EAA100" stopOpacity={0} />
                  </linearGradient>
                </defs>
                        ...
                        className={`inline-flex rounded-full border px-3 py-1 text-[10px] font-semibold uppercase tracking-widest ${
                          c.statut_production === "Livrée"
                            ...
                            : enRetard
                              ...
                              : "border-[#EAA100]/20 bg-[#EAA100]/10 text-[#EAA100]"
                        }`}
                      >
                        {c.statut_production}
                      </span>
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-4 md:gap-5">
        ...
        >
          ...
          <div className="absolute -bottom-8 -right-8 text-[120px] leading-none text-[#EAA100]/5 transition-transform duration-700 group-hover:rotate-12 group-hover:scale-110">
