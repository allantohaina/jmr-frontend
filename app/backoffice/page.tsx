...
function StatCard({
  ...
  const toneMap: Record<string, string> = {
    gold: "text-[#FFB31B] bg-[#FFB31B]/10 border-[#FFB31B]/20",
    success: "text-[#1f8457] bg-[#1f8457]/10 border-[#1f8457]/20",
    destructive: "text-[#b14255] bg-[#b14255]/10 border-[#b14255]/20",
    muted: "text-[#9aa7b4] bg-[#26313d] border-[#FFB31B]/10",
  };
  return (
    <div className="rounded-xl border border-[#FFB31B]/10 bg-[#25303a] p-4">
      ...
      {typeof progress === "number" && (
        <div className="mt-3 h-1.5 overflow-hidden rounded-full bg-[#26313d]">
          <div
            className="h-full rounded-full bg-[#FFB31B] transition-all"
    ...
    <div className="mx-auto max-w-7xl px-4 py-6 md:px-8 md:py-8">
      ...
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="flex size-10 items-center justify-center rounded-xl border border-[#FFB31B]/20 bg-[#FFB31B]/10 text-[#FFB31B]">
        ...
        <div className="flex items-center gap-3">
          <span className="rounded-md border border-[#FFB31B]/15 bg-[#25303a] px-2.5 py-1.5 font-mono text-[11px] text-[#9aa7b4]">
            v2.4
          </span>
          <Link
            href="/backoffice/orders"
            className="inline-flex items-center gap-2 rounded-lg border border-[#FFB31B]/25 bg-[#FFB31B]/10 px-4 py-2 text-[11px] font-semibold uppercase tracking-widest text-[#FFB31B] transition-colors hover:bg-[#FFB31B]/20"
          >
            Gérer les Commandes
        ...
        <div className="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
          <div className="rounded-xl border border-[#FFB31B]/10 bg-[#25303a] p-4">
            <div className="mb-3 flex items-center justify-between">
              ...
              <span className="flex size-8 items-center justify-center rounded-lg border border-[#FFB31B]/20 bg-[#FFB31B]/10 text-[#FFB31B]">
      ...
      <section className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="rounded-xl border border-[#FFB31B]/10 bg-[#25303a] p-5 md:p-6 lg:col-span-2">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-5">
              <div className="flex items-center gap-2">
                <span className="size-2.5 rounded-full bg-[#FFB31B]" />
              ...
              <AreaChart data={chartData}>
                <defs>
                  <linearGradient id="colorVentes" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#FFB31B" stopOpacity={0.25} />
                    <stop offset="95%" stopColor="#FFB31B" stopOpacity={0} />
                  </linearGradient>
                  <linearGradient id="colorDepenses" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#FFB31B" stopOpacity={0.2} />
                    <stop offset="95%" stopColor="#FFB31B" stopOpacity={0} />
                  </linearGradient>
                </defs>
                ...
                <Tooltip
                  ...
                  itemStyle={{ color: "#FFB31B", fontSize: 12 }}
                />
                <Area
                  type="monotone"
                  dataKey="ventes"
        ...
        <div className="relative flex flex-col justify-between overflow-hidden rounded-xl border border-[#FFB31B]/15 bg-gradient-to-b from-[#2b3744] to-[#25303a] p-5 md:p-6">
          <div className="absolute right-0 top-0 h-full w-1 bg-[#FFB31B]" />
          <div>
            <p className="mb-4 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-[#9aa7b4]">
              <Wallet className="size-4 text-[#FFB31B]" />
              Trésorerie
            </p>
            <div className="space-y-4">
              ...
              <div className="flex items-baseline justify-between gap-2 border-t border-[#FFB31B]/10 pt-4">
                <span className="text-[10px] font-semibold uppercase tracking-widest text-[#9aa7b4]">Soldes</span>
                <span className="font-headline text-2xl font-semibold tabular-nums text-[#FFB31B]">
          ...
          <div className="mt-6 flex items-center gap-2 text-[10px] font-semibold uppercase tracking-widest text-[#FFB31B]/80">
          ...
          {visitors.length === 0 ? (
            ...
            <div className="space-y-3">
              {visitors.map((v) => (
                <div
                  key={v.id}
                  className="flex items-center justify-between rounded-lg border border-[#FFB31B]/5 bg-[#26313d] p-3.5"
                >
                  <div className="flex items-center gap-3">
                    <span
      ...
      <section className="mb-6 space-y-4">
          ...
          <div className="flex flex-wrap gap-2.5">
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-lg border px-4 py-2.5 text-[11px] font-semibold uppercase tracking-widest transition-all ${
                filterActive
                  ? "border-[#FFB31B]/40 bg-[#FFB31B]/15 text-[#FFB31B]"
                  : "border-[#FFB31B]/15 bg-[#25303a] text-[#9aa7b4] hover:bg-[#FFB31B]/10 hover:text-[#f3e9d6]"
              }`}
            >
            ...
            <Link
              href="/backoffice/orders"
              className="inline-flex items-center gap-2 rounded-lg bg-[#FFB31B] px-4 py-2.5 text-[11px] font-bold uppercase tracking-widest text-[#171b22] transition-all hover:bg-[#FFB31B]/90"
            >
        ...
        <div className="overflow-hidden rounded-xl border border-[#FFB31B]/10 bg-[#25303a]">
          <div className="hidden grid-cols-[1fr_auto_auto_auto] items-center gap-4 border-b border-[#FFB31B]/10 px-5 py-3 text-[11px] font-semibold uppercase tracking-wider text-[#9aa7b4] md:grid">
          ...
          <div className="divide-y divide-[#FFB31B]/10">
            {isLoading ? (
              <div className="flex items-center justify-center gap-3 px-6 py-16 text-sm text-[#9aa7b4]">
                <span className="size-4 animate-spin rounded-full border-2 border-[#FFB31B]/30 border-t-[#FFB31B]" />
                Chargement…
              </div>
            ) : commandes.length === 0 ? (
                ...
                return (
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-3">
                      <div className="flex size-10 shrink-0 items-center justify-center rounded-lg border border-[#FFB31B]/10 bg-[#26313d] text-[#FFB31B]">
                        ...
                        className={`inline-flex rounded-full border px-3 py-1 text-[10px] font-semibold uppercase tracking-widest ${
                          c.statut_production === "Livrée"
                            ...
                            : enRetard
                              ...
                              : "border-[#FFB31B]/20 bg-[#FFB31B]/10 text-[#FFB31B]"
                        }`}
                      >
                        {c.statut_production}
                      </span>
                    ...
                    <div className="flex flex-col gap-1.5 md:w-48">
                      <div className="flex justify-between text-[10px] font-semibold uppercase tracking-wide text-[#9aa7b4]">
                        ...
                        <span className="text-[#FFB31B]">{pct}%</span>
                      </div>
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-4 md:gap-5">
        ...
        >
          <div className="relative z-10">
            ...
            <span className="mt-6 inline-flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#FFB31B] transition-colors group-hover:text-[#f3e9d6]">
              Suivi de Production
              <ArrowUpRight className="size-3.5 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
            </span>
          </div>
          <div className="absolute -bottom-8 -right-8 text-[120px] leading-none text-[#FFB31B]/5 transition-transform duration-700 group-hover:rotate-12 group-hover:scale-110">
            <ShieldCheck className="size-full" />
          </div>
        </Link>

        <div className="flex flex-col justify-between rounded-xl border border-[#FFB31B]/10 bg-[#25303a] p-6">
          <AlertTriangle className="size-8 text-[#FFB31B]" />
          <div>
