    ...
    <div className="px-6 md:px-12 py-10 space-y-8">
      <div className="flex justify-between items-end px-2">
        ...
        <div className="flex gap-2">
          {FILTERS.map((f) => (
            <button key={f.key} onClick={() => setFilter(f.key)} className={`rounded-lg px-3 py-1.5 text-[9px] font-bold uppercase tracking-widest transition-colors ${filter === f.key ? "bg-[#163526] text-[#EAA100]" : "border border-[#EAA100]/15 text-[#EAA100] hover:border-[#EAA100]"}`}>
              {f.label}
            </button>
          ))}
        </div>
              ...
              <div key={a.id} className="px-6 py-5">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-[#EAA100]/40 mt-1">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    {a.statut !== "pending" && (
                      <button onClick={() => setStatut(a.id, "pending")} className="rounded-lg border border-[#EAA100]/15 px-3 py-1.5 text-[9px] font-bold uppercase tracking-widest text-[#EAA100] hover:border-[#EAA100]">
                        Revenir en attente
                      </button>
                    )}
                  </div>
