  ...
  return (
    <div className="px-6 md:px-12 py-10 space-y-10">
      <div className="flex justify-between items-end px-2">
        <div>
          <h2 className="font-headline text-3xl text-[#EAA100]">Paramètres Système</h2>
          <p className="text-[#EAA100]/40 text-xs font-bold uppercase tracking-widest mt-1">Configuration de l&apos;atelier et des accès administrateur</p>
        </div>
      </div>
        ...
        <div className="bg-[#161D30] p-8 rounded-2xl border border-[#EAA100]/10 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            <div
              ...
              className="flex justify-between items-center p-4 bg-[#EAA100]/10 rounded-xl cursor-pointer hover:bg-[#EAA100]/10 transition-colors"
            >
              <div>
