  ...
  return (
    <div className="px-6 md:px-12 py-10 space-y-10">
      <div className="flex justify-between items-end px-2">
        <div>
          <h2 className="font-headline text-3xl text-[#FFB31B]">Paramètres Système</h2>
          <p className="text-[#FFB31B]/40 text-xs font-bold uppercase tracking-widest mt-1">Configuration de l&apos;atelier et des accès administrateur</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-[#25303a] p-8 rounded-2xl border border-[#FFB31B]/10 shadow-sm space-y-6">
          <h3 className="font-headline text-xl text-[#FFB31B]">Profil de l&apos;Atelier</h3>
          <div className="space-y-4">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40 mb-1">Nom de l&apos;établissement</p>
              <p className="text-[#FFB31B] font-bold">JMR Textile - Atelier de Production</p>
            </div>
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#FFB31B]/40 mb-1">Localisation</p>
              <p className="text-[#FFB31B]">Antananarivo, Madagascar</p>
            </div>
            <button
        ...
        <div className="bg-[#25303a] p-8 rounded-2xl border border-[#FFB31B]/10 shadow-sm space-y-6">
          <h3 className="font-headline text-xl text-[#FFB31B]">Sécurité & Accès</h3>
          <div className="space-y-4">
            <div
              onClick={() => setTfaEnabled(!tfaEnabled)}
              className="flex justify-between items-center p-4 bg-[#FFB31B]/10 rounded-xl cursor-pointer hover:bg-[#FFB31B]/10 transition-colors"
            >
              <div>
                <p className="text-sm font-bold text-[#FFB31B]">Double Authentification</p>
                <p className="text-[10px] text-[#FFB31B]/40 uppercase font-bold tracking-widest">Recommandé pour la sécurité</p>
              </div>
            ...
            <button
              ...
              className="w-full py-4 border border-[#FFB31B]/10 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-[#FFB31B]/10 transition-all active:scale-95"
            >
      ...
      <div className="bg-[#25303a] p-8 rounded-2xl border border-red-200 shadow-sm space-y-6">
        ...
        <p className="text-sm text-[#FFB31B]/60">
        ...
        {!showConfirm ? (
          ...
          <div className="p-4 bg-red-50 rounded-xl border border-red-200 space-y-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#25303a] border border-red-200 rounded-xl text-sm text-[#FFB31B] placeholder:text-red-300 outline-none focus:border-red-400 transition-colors"
