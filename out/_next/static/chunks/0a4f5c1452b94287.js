(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,9818,e=>{"use strict";var r=e.i(43476),t=e.i(71645),i=e.i(22016);e.i(47624);var o=e.i(21140),a=e.i(51617);function n(){let[e,n]=(0,t.useState)(""),[s,l]=(0,t.useState)(""),[d,p]=(0,t.useState)(""),[c,x]=(0,t.useState)(!1),[h,f]=(0,t.useState)(!1);(0,t.useEffect)(()=>{f(!0),(0,o.getToken)()&&(window.location.href="/atelier")},[]);let m=async r=>{if(r.preventDefault(),p(""),!a.loginRateLimiter.check("worker-login").allowed)return void p("Trop de tentatives. Veuillez réessayer plus tard.");x(!0);try{let r=new FormData;r.append("intent","login"),r.append("email",e),r.append("password",s);let t=await (0,o.authenticateWithForm)(r);t?.user?.role==="worker"?window.location.href="/atelier":p("Accès non autorisé. Vous devez être opérateur.")}catch(e){p("Email ou mot de passe incorrect.")}finally{x(!1)}};return h?(0,r.jsxs)("div",{style:{margin:0,padding:0},children:[(0,r.jsx)("style",{dangerouslySetInnerHTML:{__html:`
