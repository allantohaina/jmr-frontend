...
.suivi-scope .status{display:inline-flex;align-items:center;gap:7px;padding:7px 12px;border-radius:999px;color:var(--gold-bright);background:rgba(255,180,45,.14);font-size:12px;font-weight:600;white-space:nowrap;}
...
.suivi-scope .step.current .step-circle{border-color:var(--gold);box-shadow:0 0 0 5px rgba(255,180,45,.15);}
...
.suivi-scope .update-icon{width:34px;height:34px;flex-shrink:0;display:flex;align-items:center;justify-content:center;border-radius:50%;color:var(--gold-bright);background:rgba(255,180,45,.1);}
...
.suivi-scope .action-card{border-color:rgba(255,180,45,.45);background:linear-gradient(135deg,rgba(255,180,45,.08),transparent 55%),var(--navy-850);}
...
.suivi-scope .timeline-item.current .timeline-dot{background:var(--gold);box-shadow:0 0 0 1px var(--gold),0 0 0 5px rgba(255,180,45,.12);}
