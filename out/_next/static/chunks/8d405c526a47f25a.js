(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,14739,e=>{"use strict";var t=e.i(43476),a=e.i(71645),r=e.i(18566),i=e.i(22016),n=e.i(34461),s=e.i(7767);function o(e){if(!e)return"—";try{return new Date(e).toLocaleDateString("fr-FR",{day:"numeric",month:"long",year:"numeric"})}catch{return e}}function d(e){if(null==e)return"—";let t="string"==typeof e?parseFloat(e):e;return isNaN(t)?String(e):t.toLocaleString("fr-FR")+" Ar"}function l(e){return String(e).substring(0,8)}let c={draft:"Brouillon",pending:"En attente",accepted:"Acceptée",refused:"Refusée",expired:"Expirée",production:"En production",completed:"Terminée"},p=["Envoyé","Accepté","Production","Livraison","Terminé"];function x(){let e=(0,r.useRouter)(),x=(0,r.useSearchParams)().get("id"),[m,g]=(0,a.useState)(null),[u,f]=(0,a.useState)([]),[v,b]=(0,a.useState)([]),[j,y]=(0,a.useState)([]),[w,k]=(0,a.useState)([]),[N,z]=(0,a.useState)(!0),[L,_]=(0,a.useState)(null),[A,S]=(0,a.useState)(new Set),[M,C]=(0,a.useState)(!1),[q,B]=(0,a.useState)(!1),[V,P]=(0,a.useState)(!1),[$,W]=(0,a.useState)(""),[T,E]=(0,a.useState)(!1),[R,I]=(0,a.useState)(null),[D,F]=(0,a.useState)(null),[H,Z]=(0,a.useState)(""),[O,U]=(0,a.useState)(!1),[J,K]=(0,a.useState)(null),[Q,X]=(0,a.useState)(null),Y=(0,a.useCallback)(async e=>{let t=null;try{let e=await s.authAPI.get(`/quotes/${x}`);t=e.data??e}catch{try{let e=await s.authAPI.get(`/quote-drafts/${x}`),a=e.data??e,r=a.payload??{};t={id:a.id,name:r.name??"",message:r.message??"",category:r.category??"",quantite:null!=r.quantite?String(r.quantite):void 0,status:"draft",created_at:a.created_at??null,updated_at:a.updated_at??null,email:r.email??"",phone:r.phone??null,notifications:[]}}catch{throw Error("NOT_FOUND")}}g(t);let a=await s.authAPI.get("/commandes/").catch(()=>({data:[]})),r=(a.data??a).filter(e=>e.cotation_id===x);if(f(r),r.length>0&&S(new Set([r[0].id])),t?.status!=="draft"){let[e,t,a]=await Promise.all([s.checkpointsAPI.list(x).catch(()=>({data:[]})),s.addonsAPI.list(x).catch(()=>({data:[],total_validated:0})),s.paymentsAPI.list(x).catch(()=>({data:[],total_verified:0}))]);b(e.data??[]),y(t.data??[]),k(a.data??[])}},[x]);(0,a.useEffect)(()=>{if(!(0,n.getUser)())return void e.replace(`/mon-profil?next=/mon-profil/devis/detail?id=${x}`);if(!x){_("Aucun ID de devis fourni."),z(!1);return}(async()=>{try{let t=(0,n.getToken)();if(!t)return void e.replace(`/mon-profil?next=/mon-profil/devis/detail?id=${x}`);await Y(t)}catch{_("Impossible de charger les données du devis.")}finally{z(!1)}})()},[x,e,Y]);let G=(0,a.useCallback)(e=>{S(t=>{let a=new Set(t);return a.has(e)?a.delete(e):a.add(e),a})},[]),ee=async()=>{if(m&&confirm("Envoyer ce devis à l'atelier ? Cette action est irréversible."))try{"draft"===m.status?await s.draftsAPI.submit(String(m.id)):await s.authAPI.put(`/quotes/${m.id}`,{status:"pending"}),g({...m,status:"pending"})}catch{alert("Erreur lors de l'envoi. Réessayez.")}},et=async e=>{X(e);try{await s.checkpointsAPI.validate(e);let t=(0,n.getToken)();t&&await Y(t)}catch{}finally{X(null)}},ea=async()=>{if(m&&$.trim()){E(!0),I(null);try{await s.addonsAPI.create({quote_id:String(m.id),title:$.trim().slice(0,120)||"Demande d'ajout",description:$.trim()}),W(""),P(!1),I("Votre demande d'ajout a été transmise à l'atelier.");let e=(0,n.getToken)();e&&await Y(e)}catch{I("Impossible d'envoyer la demande. Réessayez.")}finally{E(!1)}}},er=async()=>{if(!m||!H.trim())return;let e=(0,n.getUser)();U(!0),K(null);try{await s.authAPI.post("/demandes-client/",{nom_client:[e?.first_name,e?.last_name].filter(Boolean).join(" ")||"Client",email:e?.email??m.email??"",description:H.trim(),cotation_id:String(m.id)}),Z(""),F(null),K("Votre signalement a été transmis à l'atelier.")}catch{K("Impossible d'envoyer le signalement. Réessayez.")}finally{U(!1)}},ei=m&&["accepted","production","completed"].includes(m.status??""),en=m&&Number(m.amount??0)>0,es=m?.status==="draft",eo=[{id:"cp1",title:"Prototype validé",desc:"Le modèle final a été approuvé avant lancement de la série.",meta:`Valid\xe9 par vous le ${o(m?.created_at)}`,state:"done"},{id:"cp2",title:"Premier lot — contrôle qualité",desc:"L'atelier a terminé le contrôle qualité du premier lot et attend votre retour avant de poursuivre la finition du reste de la commande.",meta:"",state:"action"},{id:"cp3",title:"Lot complet avant expédition",desc:"Vérification finale des pièces avant mise en livraison.",meta:"À venir",state:"upcoming"}],ed=v.length>0?v.map(e=>({id:e.id,title:e.title,desc:e.description??"",meta:e.validated_at?`Valid\xe9 par ${e.validated_by??"—"} le ${o(e.validated_at)}`:"upcoming"===e.status?"À venir":"",state:"done"===e.status?"done":"upcoming"===e.status?"upcoming":"action"})):eo,el=j.length>0?j.map(e=>({id:e.id,title:e.title,desc:e.description??"",price:Number(e.price??0),status:e.status??"pending"})):[{id:"a1",title:"Bouton doré supplémentaire",desc:"Ajout d'un second bouton en laiton doré.",price:15e3,status:"included"},{id:"a2",title:"Broderie motif floral",desc:"Petit motif brodé main sur la poche.",price:42e3,status:"pending"}],ec=w.find(e=>"deposit"===e.phase),ep=w.find(e=>"balance"===e.phase);if(N)return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:h}),(0,t.jsx)("div",{className:"loading-screen",children:(0,t.jsx)("div",{className:"loading-text",children:"Chargement…"})})]});if(L)return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:h}),(0,t.jsxs)("div",{className:"loading-screen",children:[(0,t.jsx)("div",{className:"error-text",children:L}),(0,t.jsx)(i.default,{href:"/mon-profil/devis",className:"back-link",children:"← Retour à mes devis"})]})]});if(!m)return null;let ex=Array.isArray(m.notifications)?m.notifications:[],em=ex.filter(e=>"delay"===e.type||"error"===e.type),eh=ex.filter(e=>"info"===e.type),eg=[...eh,...em],eu=el.filter(e=>"pending"===e.status).length,ef=el.reduce((e,t)=>e+("included"===t.status?t.price:0),0),ev=el.reduce((e,t)=>e+(t.price>0?t.price:0),0),eb=ep?.amount??m.balance_amount??Number(m.amount??0)/2;return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:h}),(0,t.jsxs)("div",{className:"page",children:[(0,t.jsx)("header",{className:"site-header",children:(0,t.jsx)("div",{className:"container site-nav",children:(0,t.jsxs)(i.default,{href:"/",className:"logo",children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",children:[(0,t.jsx)("path",{d:"M6 6L18 18M18 6L6 18",stroke:"#d9a548",strokeWidth:"1.6",strokeLinecap:"round"}),(0,t.jsx)("circle",{cx:"6",cy:"6",r:"1.6",fill:"#d9a548"}),(0,t.jsx)("circle",{cx:"6",cy:"18",r:"1.6",fill:"#d9a548"})]}),"JMR TEXTILE"]})})}),(0,t.jsxs)("main",{className:"container",children:[(0,t.jsxs)("div",{className:"breadcrumb",children:[(0,t.jsx)(i.default,{href:"/mon-profil",children:"Tableau de bord"})," / ",(0,t.jsx)(i.default,{href:"/mon-profil/devis",children:"Mes devis"})," / ",(0,t.jsxs)("span",{style:{color:"var(--text-cream)"},children:["Devis #",l(m.id)]})]}),(0,t.jsxs)("div",{className:"page-head",children:[(0,t.jsxs)("div",{className:"head-left",children:[(0,t.jsx)("div",{className:"eyebrow",children:"Suivi de devis"}),(0,t.jsx)("h1",{children:m.name||m.category||"Devis"}),(0,t.jsxs)("div",{className:"ref",children:["Réf. ",(0,t.jsxs)("b",{children:["#",l(m.id)]})," · envoyé le ",o(m.created_at)]})]}),(0,t.jsxs)("span",{className:`status-pill-lg ${m.status??""}`,children:[(0,t.jsx)("span",{className:"dot"}),c[m.status??""]??m.status]})]}),es&&(0,t.jsxs)("div",{className:"action-bar",children:[(0,t.jsxs)("div",{className:"msg",children:[(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.6",children:(0,t.jsx)("path",{d:"M12 8V13M12 16H12.01M10.3 3.9L2.8 17A2 2 0 004.5 20H19.5A2 2 0 0021.2 17L13.7 3.9A2 2 0 0010.3 3.9Z"})}),"Ce devis est encore ",(0,t.jsx)("b",{children:"en brouillon"})," — vous pouvez le modifier avant de l'envoyer à l'atelier."]}),(0,t.jsxs)("div",{className:"action-buttons",children:[(0,t.jsxs)(i.default,{href:`/demande-devis?draft=${m.id}`,className:"btn-outline",children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",children:[(0,t.jsx)("path",{d:"M11 4H6A2 2 0 004 6V18A2 2 0 006 20H18A2 2 0 0020 18V13"}),(0,t.jsx)("path",{d:"M18.5 2.5A2.1 2.1 0 0121.5 5.5L12 15L8 16L9 12L18.5 2.5Z"})]}),"Modifier le brouillon"]}),(0,t.jsxs)("button",{className:"btn-gold",onClick:ee,children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",children:[(0,t.jsx)("path",{d:"M22 2L11 13"}),(0,t.jsx)("path",{d:"M22 2L15 22L11 13L2 9L22 2Z"})]}),"Envoyer le devis"]}),(0,t.jsxs)("button",{className:"btn-outline",style:{color:"var(--warn)",borderColor:"rgba(224,139,82,0.3)"},onClick:async()=>{if(confirm("Supprimer ce brouillon ?"))try{await s.draftsAPI.remove(String(m.id)),e.push("/mon-profil/devis")}catch{alert("Erreur lors de la suppression.")}},children:[(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",children:(0,t.jsx)("path",{d:"M3 6h18M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2"})}),"Supprimer"]})]})]}),ei&&(0,t.jsxs)("div",{className:"quote-confirm",children:[(0,t.jsxs)("div",{className:"quote-confirm-top",children:[(0,t.jsx)("span",{className:"icon-box",children:(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",strokeWidth:"2",children:(0,t.jsx)("path",{d:"M4 12L9 17L20 6"})})}),(0,t.jsx)("span",{children:"Prix validé — commande définitive"})]}),(0,t.jsxs)("div",{className:"quote-figures",children:[(0,t.jsxs)("div",{className:"quote-figure",children:[(0,t.jsx)("b",{children:d(m.amount)}),(0,t.jsx)("span",{children:"Montant total chiffré"})]}),(0,t.jsxs)("div",{className:"quote-figure",children:[(0,t.jsx)("b",{children:o(m.date_livraison_prevue)}),(0,t.jsx)("span",{children:"Date de rendu"})]}),(0,t.jsxs)("div",{className:"quote-figure",children:[(0,t.jsx)("b",{children:m.admin_signature_name||m.validated_by||"—"}),(0,t.jsx)("span",{children:"Validé par"})]})]}),(0,t.jsxs)("div",{className:"quote-confirm-note",children:["Chiffré par l'atelier le ",(0,t.jsx)("b",{children:o(m.created_at)}),", puis validé par vos soins le ",(0,t.jsx)("b",{children:o(m.admin_signature_at??m.validated_at??m.created_at)}),". L'acompte de la ",(0,t.jsx)("b",{children:"tranche 1"})," a déclenché le lancement de la production."]})]}),en&&(0,t.jsxs)("div",{className:"panel",children:[(0,t.jsxs)("div",{className:"panel-header",children:[(0,t.jsx)("h3",{children:"Paiement"}),(0,t.jsx)("span",{className:"hint",children:"2 tranches"})]}),(0,t.jsxs)("div",{className:"payment-grid",children:[(0,t.jsxs)("div",{className:"payment-card",children:[(0,t.jsxs)("div",{className:"payment-card-top",children:[(0,t.jsx)("span",{className:"payment-tag",children:"Tranche 1 · Acompte (50%)"}),(0,t.jsx)("span",{className:`payment-status ${ec?.status==="verified"?"paid":"waiting"}`,children:ec?.status==="verified"?"Payé":ec?.status==="submitted"?"En attente":"À créer"})]}),(0,t.jsx)("div",{className:"payment-amount",children:d(ec?.amount??m.deposit_amount??Number(m.amount??0)/2)}),(0,t.jsx)("div",{className:"payment-desc",children:ec?.status==="verified"?`R\xe9gl\xe9 le ${o(ec.reviewed_at??ec.created_at)}`:ec?"En attente de vérification par l'atelier":"Sera créée automatiquement après validation du devis"})]}),(0,t.jsxs)("div",{className:"payment-card",children:[(0,t.jsxs)("div",{className:"payment-card-top",children:[(0,t.jsx)("span",{className:"payment-tag",children:"Tranche 2 · Solde (50%)"}),(0,t.jsx)("span",{className:`payment-status ${ep?.status==="verified"?"paid":"waiting"}`,children:ep?.status==="verified"?"Payé":"En attente"})]}),(0,t.jsx)("div",{className:"payment-amount",children:d(ep?.amount??eb)}),(0,t.jsx)("div",{className:"payment-desc",children:ep?.status==="verified"?`R\xe9gl\xe9 le ${o(ep.reviewed_at??ep.created_at)}`:ef>0?`Solde de base + ${d(ef)} d'ajouts valid\xe9s`:"Exigible à la livraison finale du dernier lot"})]})]})]}),(0,t.jsxs)("div",{className:"section-head",children:[(0,t.jsx)("h2",{children:"Commandes liées à ce devis"}),(0,t.jsxs)("span",{className:"hint",children:[u.length," commande",u.length>1?"s":""]})]}),0===u.length&&"draft"!==m.status&&(0,t.jsxs)("div",{className:"pending-info",children:[(0,t.jsx)("div",{className:"pending-info-icon",children:(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.6",children:[(0,t.jsx)("circle",{cx:"12",cy:"12",r:"9"}),(0,t.jsx)("path",{d:"M12 7V12L15 14"})]})}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"pending-info-title",children:["pending"===m.status&&"Votre demande est en cours d'examen par l'atelier.","sent"===m.status&&"Le devis vous a été envoyé — vous pouvez le consulter et le confirmer.","needs_info"===m.status&&"L'atelier a besoin d'informations complémentaires.","accepted"===m.status&&"Devis accepté — la commande sera créée prochainement.","production"===m.status&&"La commande est en cours de production.","rejected"===m.status&&"Ce devis a été refusé.",!["pending","sent","needs_info","accepted","production","rejected"].includes(m.status??"")&&"En attente de traitement par l'atelier."]}),(0,t.jsxs)("div",{className:"pending-info-detail",children:["pending"===m.status&&"Notre équipe vous répondra sous 2 à 3 jours ouvrés avec un chiffrage détaillé.","sent"===m.status&&"Vous avez 7 jours pour confirmer ou refuser ce devis.","needs_info"===m.status&&"N'hésitez pas à nous contacter pour plus de détails.","accepted"===m.status&&"Vous recevrez une notification une fois la commande lancée.","production"===m.status&&"Suivez l'avancement dans la section ci-dessus."]})]})]}),u.map(e=>{let a,r=A.has(e.id),i=function(e){if(!e)return 0;if("Livrée"===e)return 4;if("Prête"===e)return 3;let t=s.STATUTS_PRODUCTION.indexOf(e);return 2*(t>=0&&t<4)}(e.statut_production),n=(a=[],e.en_retard&&a.push({type:"warn",text:"Retard sur la date de livraison prévue"}),eu>0&&a.push({type:"warn",text:`${eu} ajout${eu>1?"s":""} en attente de chiffrage`}),e.notes&&a.push({type:"warn",text:e.notes}),a),l=function(e,t){if(!e||!t)return null;let a=new Date(e).getTime(),r=new Date(t).getTime();return isNaN(a)||isNaN(r)?null:Math.round((r-a)/864e5)}(m.date_livraison_prevue,e.date_livraison_prevue);return(0,t.jsxs)("div",{className:`order-card ${r?"open":""}`,children:[(0,t.jsxs)("div",{className:"order-summary",onClick:()=>G(e.id),children:[(0,t.jsxs)("div",{className:"order-summary-left",children:[(0,t.jsx)("span",{className:"order-icon",children:(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",strokeWidth:"1.6",children:[(0,t.jsx)("rect",{x:"4",y:"7",width:"16",height:"13",rx:"1.5"}),(0,t.jsx)("path",{d:"M8 7V5A2 2 0 0110 3H14A2 2 0 0116 5V7"})]})}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"order-title",children:["Commande #",e.numero]}),(0,t.jsxs)("div",{className:"order-sub",children:[e.quantite," pièces · créée le ",o(e.date_commande)]})]})]}),(0,t.jsxs)("div",{className:"order-summary-right",children:[n.length>0?(0,t.jsxs)("span",{className:"alert-count",children:[(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:(0,t.jsx)("path",{d:"M12 8V13M12 16.5H12.01M10.3 3.9L2.8 17A2 2 0 004.5 20H19.5A2 2 0 0021.2 17L13.7 3.9A2 2 0 0010.3 3.9Z"})}),n.length," alerte",n.length>1?"s":""]}):(0,t.jsxs)("span",{className:"alert-count none",children:[(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:(0,t.jsx)("path",{d:"M4 12L9 17L20 6"})}),"Aucune alerte"]}),(0,t.jsxs)("div",{className:"mini-progress",children:[(0,t.jsx)("div",{className:"segs",children:[0,1,2,3,4].map(e=>(0,t.jsx)("span",{className:`seg ${e<i?"filled":e===i?"current":""}`},e))}),(0,t.jsx)("span",{className:"stage-label",children:p[i]??"—"})]}),(0,t.jsx)("svg",{className:`order-chevron ${r?"open":""}`,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:(0,t.jsx)("path",{d:"M6 9L12 15L18 9"})})]})]}),r&&(0,t.jsxs)("div",{className:"order-body",children:[(0,t.jsxs)("div",{className:"panel-header",children:[(0,t.jsx)("h3",{children:"Avancement"}),(0,t.jsxs)("span",{className:"hint",children:["Mis à jour le ",o(e.updated_at??e.date_commande)]})]}),(0,t.jsxs)("div",{className:"stepper",children:[(0,t.jsx)("div",{className:"stepper-line"}),(0,t.jsx)("div",{className:"stepper-line-fill",style:{width:`${Math.min(88,8+15*i)}%`}}),p.map((e,a)=>{let r="upcoming";return a<i?r="done":a===i&&(r="current"),(0,t.jsxs)("div",{className:`step ${r}`,children:[(0,t.jsxs)("div",{className:"step-dot",children:["done"===r&&(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",strokeWidth:"2.4",strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M4 12L9 17L20 6"})}),"current"===r&&(0,t.jsx)("span",{className:"pulse"})]}),(0,t.jsx)("div",{className:"step-label",children:e})]},a)})]}),(0,t.jsxs)("div",{className:"panel-header",children:[(0,t.jsx)("h3",{children:"Étapes à valider"}),(0,t.jsxs)("span",{className:"hint",children:[ed.filter(e=>"action"===e.state).length," en attente de votre validation"]})]}),(0,t.jsx)("div",{className:"checkpoint-list",children:ed.map(e=>(0,t.jsxs)("div",{className:`checkpoint-item ${e.state}`,children:[(0,t.jsxs)("div",{className:"cp-marker",children:["done"===e.state&&(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",strokeWidth:"2.6",strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M4 12L9 17L20 6"})}),"action"===e.state&&(0,t.jsx)("span",{className:"dot-pulse"})]}),(0,t.jsxs)("div",{className:"cp-body",children:[(0,t.jsx)("div",{className:"cp-title",children:e.title}),(0,t.jsx)("div",{className:"cp-desc",children:e.desc}),e.meta&&(0,t.jsx)("div",{className:"cp-meta",children:e.meta}),"action"===e.state&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)("div",{className:"cp-actions",children:[(0,t.jsxs)("button",{className:"btn-sm-gold",onClick:()=>et(e.id),disabled:Q===e.id,children:[(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.4",children:(0,t.jsx)("path",{d:"M4 12L9 17L20 6"})}),Q===e.id?"Validation…":"Valider cette étape"]}),(0,t.jsxs)("button",{className:"btn-sm-outline",onClick:()=>{F(D===e.id?null:e.id),K(null)},children:[(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:(0,t.jsx)("path",{d:"M12 8V13M12 16.5H12.01M10.3 3.9L2.8 17A2 2 0 004.5 20H19.5A2 2 0 0021.2 17L13.7 3.9A2 2 0 0010.3 3.9Z"})}),"Signaler un problème"]})]}),D===e.id&&(0,t.jsxs)("div",{className:"addon-form open",style:{marginTop:12},children:[(0,t.jsx)("label",{children:"Décrivez le problème rencontré"}),(0,t.jsx)("textarea",{value:H,onChange:e=>Z(e.target.value),placeholder:"Ex. : La couleur du tissu ne correspond pas au prototype…"}),(0,t.jsxs)("div",{className:"form-actions",children:[(0,t.jsxs)("button",{className:"btn-sm-gold",onClick:er,disabled:O||!H.trim(),children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.4",children:[(0,t.jsx)("path",{d:"M22 2L11 13"}),(0,t.jsx)("path",{d:"M22 2L15 22L11 13L2 9L22 2Z"})]}),O?"Envoi…":"Envoyer le signalement"]}),(0,t.jsx)("button",{className:"btn-sm-outline",onClick:()=>F(null),children:"Annuler"})]}),J&&(0,t.jsx)("p",{className:"form-status",children:J})]})]})]})]},e.id))}),(0,t.jsxs)("div",{className:"highlights-grid",children:[(0,t.jsxs)("div",{className:"hl-panel warn",children:[(0,t.jsxs)("div",{className:"hl-head",children:[(0,t.jsx)("span",{className:"icon-box",children:(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",strokeWidth:"1.8",children:(0,t.jsx)("path",{d:"M12 9V13M12 16.5H12.01M10.3 3.9L2.8 17A2 2 0 004.5 20H19.5A2 2 0 0021.2 17L13.7 3.9A2 2 0 0010.3 3.9Z"})})}),(0,t.jsx)("h4",{children:"Points d'attention"}),(0,t.jsxs)("span",{children:[Math.min(em.length,3)," sur ",em.length]})]}),0===em.length?(0,t.jsx)("div",{className:"hl-empty",children:"Aucun point d'attention"}):(0,t.jsxs)(t.Fragment,{children:[em.slice(0,M?em.length:3).map((e,a)=>(0,t.jsxs)("div",{className:"hl-item",children:[(0,t.jsx)("span",{className:"num",children:String(a+1).padStart(2,"0")}),(0,t.jsxs)("div",{className:"hl-item-body",children:[(0,t.jsx)("b",{children:e.message}),e.detail&&(0,t.jsx)("p",{children:e.detail}),(0,t.jsx)("span",{className:"impact",children:e.impact??("delay"===e.type?"Retard":"À surveiller")})]})]},a)),em.length>3&&(0,t.jsxs)("button",{className:"see-more",onClick:()=>C(!M),children:[M?"Voir moins ":`Voir plus (+${em.length-3}) `,(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:(0,t.jsx)("path",{d:"M6 9L12 15L18 9"})})]})]})]}),(0,t.jsxs)("div",{className:"hl-panel good",children:[(0,t.jsxs)("div",{className:"hl-head",children:[(0,t.jsx)("span",{className:"icon-box",children:(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",strokeWidth:"1.8",children:(0,t.jsx)("path",{d:"M4 12L9 17L20 6"})})}),(0,t.jsx)("h4",{children:"Avancées"}),(0,t.jsxs)("span",{children:[Math.min(eh.length,3)," sur ",eh.length]})]}),0===eh.length?(0,t.jsx)("div",{className:"hl-empty",children:"Aucune avancée signalée"}):(0,t.jsxs)(t.Fragment,{children:[eh.slice(0,q?eh.length:3).map((e,a)=>(0,t.jsxs)("div",{className:"hl-item",children:[(0,t.jsx)("span",{className:"num",children:String(a+1).padStart(2,"0")}),(0,t.jsxs)("div",{className:"hl-item-body",children:[(0,t.jsx)("b",{children:e.message}),e.detail&&(0,t.jsx)("p",{children:e.detail}),(0,t.jsx)("span",{className:"impact",children:e.impact??"Terminé"})]})]},a)),eh.length>3&&(0,t.jsxs)("button",{className:"see-more",onClick:()=>B(!q),children:[q?"Voir moins ":`Voir plus (+${eh.length-3}) `,(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:(0,t.jsx)("path",{d:"M6 9L12 15L18 9"})})]})]})]})]}),(0,t.jsxs)("div",{className:"panel-header",children:[(0,t.jsx)("h3",{children:"Ajouts demandés"}),(0,t.jsxs)("span",{className:"hint",children:["+",ev.toLocaleString("fr-FR")," Ar au total"]})]}),(0,t.jsxs)("div",{className:"addon-section",children:[el.map(e=>(0,t.jsxs)("div",{className:"addon-item",children:[(0,t.jsxs)("div",{className:"addon-left",children:[(0,t.jsx)("b",{children:e.title}),(0,t.jsx)("p",{children:e.desc})]}),(0,t.jsxs)("div",{className:"addon-right",children:[(0,t.jsxs)("span",{className:"addon-price",children:["+",e.price.toLocaleString("fr-FR")," Ar"]}),(0,t.jsx)("span",{className:`addon-status ${e.status}`,children:"included"===e.status?"Inclus au total":"rejected"===e.status?"Refusé":"En attente de chiffrage"})]})]},e.id)),(0,t.jsxs)("div",{className:"addon-total",children:[(0,t.jsx)("span",{children:"Total des ajouts validés, ajouté au solde de livraison"}),(0,t.jsxs)("b",{children:["+",ef.toLocaleString("fr-FR")," Ar"]})]}),R&&(0,t.jsx)("p",{className:"form-status",children:R}),(0,t.jsxs)("button",{className:"addon-add-btn",onClick:()=>{P(!V),I(null)},children:[(0,t.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:(0,t.jsx)("path",{d:"M12 5V19M5 12H19"})}),"Demander un ajout"]}),V&&(0,t.jsxs)("div",{className:"addon-form open",children:[(0,t.jsx)("label",{children:"Décrivez ce que vous souhaitez ajouter ou modifier"}),(0,t.jsx)("textarea",{value:$,onChange:e=>W(e.target.value),placeholder:"Ex. : Ajouter un motif brodé sur la manche gauche, changer la couleur des boutons…"}),(0,t.jsx)("p",{className:"hint-sm",children:"L'atelier vous répondra avec un chiffrage de l'ajout avant de l'intégrer à la commande."}),(0,t.jsxs)("button",{className:"btn-sm-gold",onClick:ea,disabled:T||!$.trim(),children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.4",children:[(0,t.jsx)("path",{d:"M22 2L11 13"}),(0,t.jsx)("path",{d:"M22 2L15 22L11 13L2 9L22 2Z"})]}),T?"Envoi…":"Envoyer la demande"]})]})]}),(0,t.jsxs)("div",{className:"panel-header",children:[(0,t.jsx)("h3",{children:"Retour de l'atelier"}),(0,t.jsxs)("span",{className:"hint",children:[eg.length," message",eg.length>1?"s":""]})]}),(0,t.jsx)("div",{children:0===eg.length?(0,t.jsx)("div",{className:"hl-empty",style:{padding:"20px 0"},children:"Aucun message de l'atelier pour le moment."}):eg.map((e,a)=>(0,t.jsxs)("div",{className:"feedback-item",children:[(0,t.jsx)("div",{className:"fb-avatar",children:"A"}),(0,t.jsxs)("div",{className:"fb-body",children:[(0,t.jsxs)("div",{className:"fb-top",children:[(0,t.jsx)("span",{className:"fb-name",children:"Atelier JMR"}),(0,t.jsx)("span",{className:"fb-date",children:o(e.date??e.created_at)})]}),(0,t.jsx)("p",{className:"fb-text",children:e.message})]})]},a))}),(0,t.jsxs)("div",{className:"panel-header",children:[(0,t.jsx)("h3",{children:"Comparatif devis · commande · livraison"}),(0,t.jsx)("span",{className:"hint",children:"Se complète automatiquement"})]}),(0,t.jsxs)("table",{className:"compare-table",children:[(0,t.jsx)("thead",{children:(0,t.jsxs)("tr",{children:[(0,t.jsx)("th",{}),(0,t.jsx)("th",{children:"Devis"}),(0,t.jsx)("th",{className:"col-active",children:"Bon de commande"}),(0,t.jsx)("th",{children:"Livraison"})]})}),(0,t.jsxs)("tbody",{children:[(0,t.jsxs)("tr",{children:[(0,t.jsx)("td",{children:"Quantité"}),(0,t.jsxs)("td",{children:[m.quantite??"—"," pièces"]}),(0,t.jsxs)("td",{className:"col-active",children:[e.quantite," pièces"]}),(0,t.jsx)("td",{children:e.date_livraison_reelle?`${e.pieces_produites??"—"} pi\xe8ces`:(0,t.jsxs)("span",{className:"pending-tag",children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",children:[(0,t.jsx)("circle",{cx:"12",cy:"12",r:"9"}),(0,t.jsx)("path",{d:"M12 7V12L15 14"})]}),"À venir"]})})]}),(0,t.jsxs)("tr",{children:[(0,t.jsx)("td",{children:"Prix unitaire"}),(0,t.jsx)("td",{children:d(e.quantite?Number(m.amount??0)/e.quantite:null)}),(0,t.jsx)("td",{className:"col-active",children:d(e.prix_unitaire)}),(0,t.jsx)("td",{children:e.date_livraison_reelle?d(e.total):(0,t.jsxs)("span",{className:"pending-tag",children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",children:[(0,t.jsx)("circle",{cx:"12",cy:"12",r:"9"}),(0,t.jsx)("path",{d:"M12 7V12L15 14"})]}),"À venir"]})})]}),(0,t.jsxs)("tr",{children:[(0,t.jsx)("td",{children:"Date de rendu"}),(0,t.jsx)("td",{children:o(m.date_livraison_prevue)}),(0,t.jsxs)("td",{className:"col-active",children:[o(e.date_livraison_prevue),null!==l&&l>0&&(0,t.jsxs)("span",{style:{color:"var(--warn)",fontSize:"11px"},children:[" (+",l,"j)"]})]}),(0,t.jsx)("td",{children:e.date_livraison_reelle?o(e.date_livraison_reelle):(0,t.jsxs)("span",{className:"pending-tag",children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",children:[(0,t.jsx)("circle",{cx:"12",cy:"12",r:"9"}),(0,t.jsx)("path",{d:"M12 7V12L15 14"})]}),"À venir"]})})]}),(0,t.jsxs)("tr",{children:[(0,t.jsx)("td",{children:"Statut"}),(0,t.jsx)("td",{children:c[m.status??""]??m.status}),(0,t.jsx)("td",{className:"col-active",children:e.statut_production??"—"}),(0,t.jsx)("td",{children:e.date_livraison_reelle?"Livré":(0,t.jsxs)("span",{className:"pending-tag",children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",children:[(0,t.jsx)("circle",{cx:"12",cy:"12",r:"9"}),(0,t.jsx)("path",{d:"M12 7V12L15 14"})]}),"Non généré"]})})]})]})]})]})]},e.id)})]}),(0,t.jsx)("footer",{className:"site-footer",children:"JMR Textile © 2026 — Suivi mis à jour automatiquement par l'atelier"})]})]})}function m(){return(0,t.jsx)(a.Suspense,{fallback:(0,t.jsx)("div",{className:"loading-screen",children:(0,t.jsx)("div",{className:"loading-text",children:"Chargement…"})}),children:(0,t.jsx)(x,{})})}let h=`
:root{
  --bg-deep:#131c2b;
  --bg-panel:#0f1826;
  --card:#1b263c;
